...
PlaceHolder pl;
    ...
    try {
    String sql = "SELECT * FROM datapenilaian where id_kurir LIKE '"+cariitem+"' or nmakurir LIKE '"+cariitem+"' "
            + "or K1 LIKE '"+cariitem+"' ";
    Statement stat = conn.createStatement();
    ResultSet hasil = stat.executeQuery(sql);
    while (hasil.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popup_penilaian.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
